...
import com.bucket.boardserver.mapper.CategoryMapper;
import com.bucket.boardserver.service.CategoryService;
...
public class CategoryServiceImpl implements CategoryService {
    ...
    public void delete(int categoryId) {
        if(categoryId != 0){
            ...
            throw new RuntimeException("register ERROR! 게시글 카테고리 삭제 메서드를 확인해주세요" + categoryId);
        }
